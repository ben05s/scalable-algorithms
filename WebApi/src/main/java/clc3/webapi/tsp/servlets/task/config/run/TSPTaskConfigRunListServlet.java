...
@WebServlet(urlPatterns = "/tsp/task/config/runs")
public class TSPTaskConfigRunListServlet extends IdRequestServlet {
    ...
    protected void process(HttpServletRequest request, HttpServletResponse response)
        ...
        for (TSPTaskConfigRun taskConfigRun : taskConfigRunDao.getByConfig(taskConfigKey)) {
